...
class MCSimulation:
    ...
    def calc_cumulative_return(self):
        ...
        for n in range(self.nSim):
            ...
            # Create a new DataFrame with the same data as portfolio_cumulative_returns
            newframe = portfolio_cumulative_returns.copy()

            # Update the new DataFrame with the new column
            newframe[n] = (1 + sim_df.fillna(0)).cumprod()
            
            # Assign the updated DataFrame back to portfolio_cumulative_returns
            portfolio_cumulative_returns = newframe
